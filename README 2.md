...
## How to get started
1. Clone or [download](https://github.com/freeshifter/gatherpress-tailwind/archive/master.zip "Download the WP Tailwind Zip") the project onto your `themes` directory `(./wp-content/themes)`
2. Run a find/replace for the following strings:
- `gatherpress-tailwind`
- `GatherPress_Tailwind`
- `gatherpress_tailwind_`
